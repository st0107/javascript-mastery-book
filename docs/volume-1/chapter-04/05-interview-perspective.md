...
- What is Explicit conversion with String, Number, Boolean, and BigInt, and when would you use it?
- What is Implicit conversion rules, and when would you use it?
- What is Truthy and falsy values, and when would you use it?
- What is Loose equality versus strict equality, and when would you use it?

## Intermediate Questions

- What bugs can appear when a developer misunderstands Truthy and falsy values?
- What bugs can appear when a developer misunderstands Loose equality versus strict equality?
- What bugs can appear when a developer misunderstands Abstract relational comparison?
- What bugs can appear when a developer misunderstands Object-to-primitive conversion?
